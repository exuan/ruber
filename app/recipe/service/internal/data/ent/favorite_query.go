...
// Returns a *NotSingularError when exactly one Favorite entity is not found.
...
// Returns a *NotSingularError when exactly one Favorite ID is not found.
...
func (fq *FavoriteQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64

...
func (uu *UserUpdate) SetOwner(s string) *UserUpdate {
	uu.mutation.SetOwner(s)
	return uu
}

// SetApp sets the "app" field.
func (uu *UserUpdate) SetApp(s string) *UserUpdate {
	uu.mutation.SetApp(s)
	return uu
}

// SetNillableApp sets the "app" field if the given value is not nil.
func (uu *UserUpdate) SetNillableApp(s *string) *UserUpdate {
	if s != nil {
		uu.SetApp(*s)
	}
	return uu
...
func (uu *UserUpdate) SetProperties(m map[string]interface{}) *UserUpdate {
	uu.mutation.SetProperties(m)
	return uu
}
...
func (uu *UserUpdate) SetModifier(s string) *UserUpdate {
	uu.mutation.SetModifier(s)
	return uu
}
...
func (uu *UserUpdate) check() error {
	if v, ok := uu.mutation.UpdateTime(); ok {
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := uu.mutation.Owner(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
	...
	if value, ok := uu.mutation.App(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
	...
	if value, ok := uu.mutation.Properties(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeJSON,
			Value:  value,
	...
	if value, ok := uu.mutation.Modifier(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
...
// SetOwner sets the "owner" field.
func (uuo *UserUpdateOne) SetOwner(s string) *UserUpdateOne {
	uuo.mutation.SetOwner(s)
	return uuo
}

// SetApp sets the "app" field.
func (uuo *UserUpdateOne) SetApp(s string) *UserUpdateOne {
	uuo.mutation.SetApp(s)
	return uuo
}

// SetNillableApp sets the "app" field if the given value is not nil.
func (uuo *UserUpdateOne) SetNillableApp(s *string) *UserUpdateOne {
	if s != nil {
		uuo.SetApp(*s)
	}
	return uuo
...
// SetProperties sets the "properties" field.
func (uuo *UserUpdateOne) SetProperties(m map[string]interface{}) *UserUpdateOne {
	uuo.mutation.SetProperties(m)
	return uuo
}
...
// SetModifier sets the "modifier" field.
func (uuo *UserUpdateOne) SetModifier(s string) *UserUpdateOne {
	uuo.mutation.SetModifier(s)
	return uuo
}
...
func (uuo *UserUpdateOne) check() error {
	if v, ok := uuo.mutation.UpdateTime(); ok {
		if err := user.UpdateTimeValidator(v); err != nil {
			return &ValidationError{Name: "update_time", err: fmt.Errorf("ent: validator failed for field \"update_time\": %w", err)}
		}
	}
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if value, ok := uuo.mutation.Owner(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: user.FieldOwner,
	...
	if value, ok := uuo.mutation.App(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: user.FieldApp,
	...
	if value, ok := uuo.mutation.Properties(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeJSON,
			Value:  value,
			Column: user.FieldProperties,
	...
	if value, ok := uuo.mutation.Modifier(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: user.FieldModifier,
